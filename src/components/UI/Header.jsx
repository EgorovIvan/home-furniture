...
const Header = ({countProduct}) => {
    ...
    const [showFormNav, setShowFormNav] = useState(false)
    const [styleCountProduct, setStyleCountProduct] = useState({visibility: "hidden"})

    const openFormReg = () => setShowFormReg(true)
    const closeFormReg = () => setShowFormReg(false)
    ...
    return (
        <header className="header">
            <div className="container" onClick={() => {
                if (showFormReg === true) closeFormReg()
                if (showFormNav === true) closeFormNav()
            }}>
                <div className="header__inner">
                    <nav className="menu">
                        ...
                        <ListButton
                            ...
                            openFormNav={openFormNav}
                            closeFormNav={closeFormNav}/>
                    ...
                    <ul className="profile__list">
                        <li className="profile__item">
                            <button className="profile__link link-icon" onClick={openFormReg}>
                                <svg className="icon" width="29" height="29" viewBox="0 0 29 29"
