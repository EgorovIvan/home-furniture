                ...
                <div className="breadcrumbs">
                    <div className="container">
                        <ul className="breadcrumbs__links">
                            ...
                            <li className="breadcrumbs__item">
                                <span className="breadcrumbs_link">Мангалы</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <section className="container">
                    <div className="tables">
                        <div className="tables__items">
                            ...
                            <a className="tables__item" href="#">
                                <img src="./../../images/catalog/Мангалы/мангалы_2.jpg" alt=""/>
                                <div className="tables__desc">
                                    <p className="tables__desc-text">
                                        Описание:
                                    </p>
                            ...
                            <a className="tables__item" href="#">
                                <img src="./../../images/catalog/Мангалы/мангалы_3.jpg" alt=""/>
                                <div className="tables__desc">
                                    <p className="tables__desc-text">
                                        Описание:
                                    </p>
                            ...
                            <a className="tables__item" href="#">
                                <img src="./../../images/catalog/Мангалы/мангалы_4.jpg" alt=""/>
                                <div className="tables__desc">
                                    <p className="tables__desc-text">
                                        Описание:
                                    </p>
